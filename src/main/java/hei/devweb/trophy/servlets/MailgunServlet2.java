...
@WebServlet(name = "mailgun", value = "/connexion/send/email") // mapping de la servlet (url)
public class MailgunServlet2 extends AbstractGenericServlet {
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    SendSimpleMessage(messageContact);
    resp.sendRedirect("../../connexion");
  }

  public static ClientResponse SendSimpleMessage(String messageContact) {
	    ...
	    formData.add("from", "4L TROPHY <postmaster@sandboxaae99410e2e74bbc9d80aaceac26cc8c.mailgun.org>");
	    /*formData.add("to","hei.4l-trophy@hei.yncrea.fr"); */
	    formData.add("subject", "Récupération du mot de passe");
	    formData.add("text", "Votre mot de passe est 'mdp' ");
